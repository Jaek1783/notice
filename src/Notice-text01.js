...
function Text01(){
    ...
    const news = [
        {num:15, title:"공지사항", date:"2022-04-15", body:"2022-04-15 공지사항 입니다."},
        {num:14, title:"공지사항", date:"2022-04-14", body:"2022-04-14 공지사항 입니다."},
        {num:13, title:"공지사항", date:"2022-04-13", body:"2022-04-13 공지사항 입니다."}, 
        {num:12, title:"공지사항", date:"2022-04-12", body:"2022-04-12 공지사항 입니다."},
        {num:11, title:"공지사항", date:"2022-04-11", body:"2022-04-11 공지사항 입니다."}
    ];
    let content = null;
    if(mode == 'read'){
