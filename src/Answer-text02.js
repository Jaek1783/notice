...
function Text02(){
    ...
    const news = [
        {num:10, title:"제목12", date:"2022-04-12", body:"질문4"},
        {num:'0'+ 9, title:"제목12", date:"2022-04-12", body:"질문4"},
        {num:'0'+ 8, title:"제목12", date:"2022-04-12", body:"질문4"},
        {num:'0'+ 7, title:"제목12", date:"2022-04-12", body:"질문4"},
        {num:'0'+ 6, title:"제목11", date:"2022-04-11", body:"질문5"}
    ];
    let content = null;
    if(mode == 'read'){
